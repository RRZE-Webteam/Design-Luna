    ...
    while (have_posts()) : the_post();
        ...
        <div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
            ...
            <div class="post-entry">
                ...
                the_content();
                luna_talk_fields();
                if (($options['aktiv-registration-link'] == 1) && ($options['registration-link'] != '')) {
                    echo "<a class=\"registration-link\" href=\"" . home_url() . "/" . $options['registration-link'] . "\">" . __('Register online', 'luna') . "</a>";
                }
                ?>
            </div>

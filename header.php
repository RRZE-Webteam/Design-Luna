    ...
    <head>
        ...
        <script language="JavaScript" type="text/javascript">
            ...
            jQuery(document).ready(function () {
                jQuery('#toggle-menu .slide_button').click(function () {
                    jQuery('#sidebar').slideUp('400');
                ...
                jQuery('#toggle-sidebar .slide_button').click(function () {
                    if (document.documentElement.clientWidth <= 600) {
                        jQuery('#menu').slideUp('400');
                    };
                    jQuery('#sidebar').slideToggle('400', function () {
                        if (jQuery('#sidebar').is(':visible')) {
                            jQuery('.sidebar-arrow').text('\u25B2');
                        } else {
                            jQuery('.sidebar-arrow').text('\u25BC');
                        }
                    });
            ...
            <div id="seite" class="page">  <!-- begin: seite -->
                ...
                <div id="main">  <!-- begin: main -->
                    ...
                    <div id="toggle-sidebar">
                        <a class="slide_button noprint" title="Click to Show or Hide the Sidebar" href="#">Sidebar <span class="sidebar-arrow">&#9660;</span></a>
                    </div>
                    ...
                    <div id="content">  <!-- begin: content -->
                        ...
                        <div id="titel">
                            <h1>
                                ...
                                <?php elseif (is_archive() && ('talk' == get_post_type() )) : ?>
                                    <?php print $options['label-talk-pl']; ?>
